...
class App:
    ...
    def draw_holds(self, screen):
        ...
        g = self.gestures
        for hold, label, color in ((g.confirm, "confirmando (sinal de OK)", YELLOW),
    ...
    def draw_end_panel(self, screen):
        ...
        if self.scene == "level_done":
            ...
            hint = "sinal de OK: loja" if run.level_idx + 1 < len(LEVELS) else "sinal de OK: continuar"
