...
class GestureInput:
    ...
    Jogo: esquerda INDEX anda para frente (direita da tela), THUMB para trás, resto para;
    direita com indicador, polegar ou os dois levantados pula uma vez (borda).
    ...
    def read(self, stable: dict, dt: float = 1 / 60) -> Input:
        ...
        jump = right in self.JUMP and self.prev_right not in self.JUMP
