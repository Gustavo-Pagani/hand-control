...
from handcontrol import assets
from handcontrol.config import TILE
from handcontrol.game import Game
from handcontrol.inputs import Input
from handcontrol.level import load_level
from handcontrol.levels import LEVELS
...
def run_all(namespace):
    pygame.init()
    for k, fn in list(namespace.items()):
